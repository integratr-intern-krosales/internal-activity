...
<div class="container">
    <form class="form" method="POST" action="actions.php">
        ...
        <div class="mb-3"><label for="gender" class="form-label">Gender</label>
            ...
            name="gender" value="<?php echo $result['gender'] ?>">
        </div>
        <div class="mb-3"> <label for="place_of_birth" class="form-label">Place of Birth</label>
            <input type="text" class="form-control" id="place_of_birth"
             name="place_of_birth" value="<?php echo $result['place_of_birth'] ?>">
        </div>
        <div class="mb-3"><label for="place_of_birth" class="form-label">Birthday</label>
            <input type="date" class="form-control" id="place_of_birth" 
            name="birthday" value="<?php echo $result['birthday'] ?>">
        </div>
        <input type="submit" name="update_person" value="Update Person" class="btn btn-outline-primary">
    </form>
</div>  
